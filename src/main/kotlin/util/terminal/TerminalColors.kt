...
import quark.util.strings.replaceMany

enum class TerminalColor(val ansiCode: String) {
    RESET("\u001b[0m"),
    BLACK("\u001b[0;30m"),
    RED("\u001b[0;31m"),
    GREEN("\u001b[0;32m"),
...
fun String?.paint(vararg colors: TerminalColor) =
    colors.joinToString("") + this.toString() + TerminalColor.RESET

private val String.colorless: String
    get() = replaceMany(TerminalColor.entries.associate { it.ansiCode to "" })

val String.coloredLength: Int
    get() = colorless.length
